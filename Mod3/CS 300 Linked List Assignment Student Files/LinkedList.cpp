...
void LinkedList::Prepend(Bid bid) {
    ...
    if (head != nullptr) {
        ...
        // If list is empty, new node also becomes the tail
        tail = newNode;
    }
...
void LinkedList::Remove(string bidId) {
    ...
    if (head != nullptr && head->bid.bidId == bidId) {
        ...
        // If head becomes nullptr, also update tail
        if (head == nullptr) {
            tail = nullptr;
        }
        
        // Delete the old head node and decrease size count
        delete temp;
        size--;
        return;
    }
    ...
    while (current != nullptr && current->next != nullptr) {
        ...
        if (current->next->bid.bidId == bidId) {
            ...
            // Decrease size count and return
            size--;
            return;
        }
